...
class TestRegistry:
    def test_load_models_empty(self, tmp_registry):
        assert reg.load_models() == []

    def test_add_and_load_model(self, tmp_registry, sample_model_data):
    ...
    def test_find_model(self, tmp_registry, sample_model_data):
    ...
    def test_update_model(self, tmp_registry, sample_model_data):
        reg.add_model(Model(**sample_model_data))
    ...
    def test_remove_model(self, tmp_registry, sample_model_data):
        reg.add_model(Model(**sample_model_data))
    ...
    def test_is_registered(self, tmp_registry, sample_model_data):
        reg.add_model(Model(**sample_model_data))
    ...
    def test_save_empty_models(self, tmp_registry):
        reg.save_models([])
        assert reg.load_models() == []
...
class TestDownloads:
    ...
    def test_update_download(self, tmp_registry):
        dl = Download(url="https://example.com/m.gguf",
                      destination="/tmp/m.gguf")
        reg.add_download(dl)
    ...
    def test_empty_downloads(self, tmp_registry):
